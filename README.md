...
```
npm install flowhunt@3.18.2 --save
```
...
------------ | ------------- | ------------- | -------------
*AgentGridsApi* | [**createAgentGrid**](docs/AgentGridsApi.md#createagentgrid) | **POST** /v2/agent_grids/ | Create a Flow Table
*AgentGridsApi* | [**deleteAgentGrid**](docs/AgentGridsApi.md#deleteagentgrid) | **DELETE** /v2/agent_grids/{agent_grid_id} | Delete a Flow Table
*AgentGridsApi* | [**deleteAgentGridRow**](docs/AgentGridsApi.md#deleteagentgridrow) | **DELETE** /v2/agent_grids/{agent_grid_id}/rows/{row_id} | Delete a row
*AgentGridsApi* | [**getAgentGrid**](docs/AgentGridsApi.md#getagentgrid) | **GET** /v2/agent_grids/{agent_grid_id} | Get a Flow Table
*AgentGridsApi* | [**getAgentGridPreview**](docs/AgentGridsApi.md#getagentgridpreview) | **GET** /v2/agent_grids/{agent_grid_id}/preview | Get Flow Table preview
*AgentGridsApi* | [**getImportStatus**](docs/AgentGridsApi.md#getimportstatus) | **GET** /v2/agent_grids/{agent_grid_id}/import-status/{import_id} | Get import status
*AgentGridsApi* | [**importAgentGridCsv**](docs/AgentGridsApi.md#importagentgridcsv) | **POST** /v2/agent_grids/{agent_grid_id}/import-csv | Import CSV
*AgentGridsApi* | [**insertRow**](docs/AgentGridsApi.md#insertrow) | **POST** /v2/agent_grids/{agent_grid_id}/rows | Insert a row
*AgentGridsApi* | [**insertRowsBulk**](docs/AgentGridsApi.md#insertrowsbulk) | **POST** /v2/agent_grids/{agent_grid_id}/rows/bulk | Bulk insert rows
*AgentGridsApi* | [**listAgentGrids**](docs/AgentGridsApi.md#listagentgrids) | **GET** /v2/agent_grids/ | List all Flow Tables
*AgentGridsApi* | [**searchRows**](docs/AgentGridsApi.md#searchrows) | **POST** /v2/agent_grids/{agent_grid_id}/search | Search rows
*AirtableApi* | [**getAirtableBases**](docs/AirtableApi.md#getairtablebases) | **GET** /v2/integrations/airtable/ | Get Airtable Bases
*AirtableApi* | [**getAirtableTables**](docs/AirtableApi.md#getairtabletables) | **GET** /v2/integrations/airtable/bases/{base_id}/tables | Get Airtable Tables
...
*AtlassianApi* | [**deleteJiraWebhook**](docs/AtlassianApi.md#deletejirawebhook) | **DELETE** /v2/integrations/atlassian/jira/webhooks/{webhook_id} | Delete Jira Webhook
*AtlassianApi* | [**getConfluencePages**](docs/AtlassianApi.md#getconfluencepages) | **GET** /v2/integrations/atlassian/confluence/spaces/{space_key}/pages | Get Confluence Pages
*AtlassianApi* | [**getConfluenceSpaces**](docs/AtlassianApi.md#getconfluencespaces) | **GET** /v2/integrations/atlassian/confluence/spaces | Get Confluence Spaces
*AtlassianApi* | [**getJiraAssignees**](docs/AtlassianApi.md#getjiraassignees) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/assignees | Get Jira Assignees
*AtlassianApi* | [**getJiraIssues**](docs/AtlassianApi.md#getjiraissues) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/issues | Get Jira Issues
*AtlassianApi* | [**getJiraProjects**](docs/AtlassianApi.md#getjiraprojects) | **GET** /v2/integrations/atlassian/jira/projects | Get Jira Projects
*AtlassianApi* | [**getJiraTransitions**](docs/AtlassianApi.md#getjiratransitions) | **GET** /v2/integrations/atlassian/jira/issues/{issue_key}/transitions | Get Jira Transitions
*AtlassianApi* | [**listJiraWebhooks**](docs/AtlassianApi.md#listjirawebhooks) | **GET** /v2/integrations/atlassian/jira/webhooks | List Jira Webhooks
...
*ClickUpApi* | [**getClickupSpaces**](docs/ClickUpApi.md#getclickupspaces) | **GET** /v2/integrations/clickup/{integration_id}/spaces | Get Clickup Spaces
*ClickUpApi* | [**getClickupWorkspaces**](docs/ClickUpApi.md#getclickupworkspaces) | **GET** /v2/integrations/clickup/ | Get Clickup Workspaces
*CreditsApi* | [**getCreditBalance**](docs/CreditsApi.md#getcreditbalance) | **GET** /v2/credits/balance | Get Credit Balance
*CreditsApi* | [**getDailyChartData**](docs/CreditsApi.md#getdailychartdata) | **POST** /v2/credits/daily/chart | Get Daily Chart Data
...
*DefaultApi* | [**getBranding**](docs/DefaultApi.md#getbranding) | **GET** /v2/settings/branding | Get Branding
*DefaultApi* | [**getPublicBranding**](docs/DefaultApi.md#getpublicbranding) | **GET** /v2/settings/branding/public | Get Public Branding
*DefaultApi* | [**updateBranding**](docs/DefaultApi.md#updatebranding) | **PUT** /v2/settings/branding | Update Branding
...
*FlowAssistantV3Api* | [**createV3FlowAssistantSession**](docs/FlowAssistantV3Api.md#createv3flowassistantsession) | **POST** /v3/flow-assistants/create | Create V3 Flow Assistant Session
*FlowAssistantV3Api* | [**invokeV3FlowAssistantResponse**](docs/FlowAssistantV3Api.md#invokev3flowassistantresponse) | **POST** /v3/flow-assistants/{session_id}/invoke | Invoke V3 Flow Assistant Response
*FlowAssistantV3Api* | [**pollV3FlowAssistantResponse**](docs/FlowAssistantV3Api.md#pollv3flowassistantresponse) | **POST** /v3/flow-assistants/{session_id}/invocation_response/{from_timestamp} | Poll V3 Flow Assistant Response
*FlowBatchApi* | [**addRows**](docs/FlowBatchApi.md#addrows) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/rows | Add Rows
*FlowBatchApi* | [**addRows_0**](docs/FlowBatchApi.md#addrows_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/rows | Add Rows
*FlowBatchApi* | [**createBatchRun**](docs/FlowBatchApi.md#createbatchrun) | **POST** /v2/flows/{flow_id}/batch | Create Batch Run
*FlowBatchApi* | [**createBatchRun_0**](docs/FlowBatchApi.md#createbatchrun_0) | **POST** /v2/flows/{flow_id}/batch | Create Batch Run
*FlowBatchApi* | [**deleteBatchRun**](docs/FlowBatchApi.md#deletebatchrun) | **DELETE** /v2/flows/{flow_id}/batch/{batch_run_id} | Delete Batch Run
*FlowBatchApi* | [**deleteBatchRun_0**](docs/FlowBatchApi.md#deletebatchrun_0) | **DELETE** /v2/flows/{flow_id}/batch/{batch_run_id} | Delete Batch Run
*FlowBatchApi* | [**deleteRow**](docs/FlowBatchApi.md#deleterow) | **DELETE** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id} | Delete Row
*FlowBatchApi* | [**deleteRow_0**](docs/FlowBatchApi.md#deleterow_0) | **DELETE** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id} | Delete Row
*FlowBatchApi* | [**executeBatch**](docs/FlowBatchApi.md#executebatch) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/execute | Execute Batch
*FlowBatchApi* | [**executeBatch_0**](docs/FlowBatchApi.md#executebatch_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/execute | Execute Batch
*FlowBatchApi* | [**executeFiltered**](docs/FlowBatchApi.md#executefiltered) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/execute-filtered | Execute Filtered
*FlowBatchApi* | [**executeFiltered_0**](docs/FlowBatchApi.md#executefiltered_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/execute-filtered | Execute Filtered
*FlowBatchApi* | [**executeRow**](docs/FlowBatchApi.md#executerow) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id}/execute | Execute Row
*FlowBatchApi* | [**executeRow_0**](docs/FlowBatchApi.md#executerow_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id}/execute | Execute Row
*FlowBatchApi* | [**exportCsv**](docs/FlowBatchApi.md#exportcsv) | **GET** /v2/flows/{flow_id}/batch/{batch_run_id}/export-csv | Export Csv
*FlowBatchApi* | [**exportCsv_0**](docs/FlowBatchApi.md#exportcsv_0) | **GET** /v2/flows/{flow_id}/batch/{batch_run_id}/export-csv | Export Csv
*FlowBatchApi* | [**getBatchRun**](docs/FlowBatchApi.md#getbatchrun) | **GET** /v2/flows/{flow_id}/batch/{batch_run_id} | Get Batch Run
*FlowBatchApi* | [**getBatchRun_0**](docs/FlowBatchApi.md#getbatchrun_0) | **GET** /v2/flows/{flow_id}/batch/{batch_run_id} | Get Batch Run
*FlowBatchApi* | [**getExportZipStatus**](docs/FlowBatchApi.md#getexportzipstatus) | **GET** /v2/flows/{flow_id}/batch/{batch_run_id}/export-zip/{task_id} | Get Export Zip Status
*FlowBatchApi* | [**getExportZipStatus_0**](docs/FlowBatchApi.md#getexportzipstatus_0) | **GET** /v2/flows/{flow_id}/batch/{batch_run_id}/export-zip/{task_id} | Get Export Zip Status
*FlowBatchApi* | [**importCsv**](docs/FlowBatchApi.md#importcsv) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/import-csv | Import Csv
*FlowBatchApi* | [**importCsv_0**](docs/FlowBatchApi.md#importcsv_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/import-csv | Import Csv
*FlowBatchApi* | [**listBatchRuns**](docs/FlowBatchApi.md#listbatchruns) | **GET** /v2/flows/{flow_id}/batch | List Batch Runs
*FlowBatchApi* | [**listBatchRuns_0**](docs/FlowBatchApi.md#listbatchruns_0) | **GET** /v2/flows/{flow_id}/batch | List Batch Runs
*FlowBatchApi* | [**startExportZip**](docs/FlowBatchApi.md#startexportzip) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/export-zip | Start Export Zip
*FlowBatchApi* | [**startExportZip_0**](docs/FlowBatchApi.md#startexportzip_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/export-zip | Start Export Zip
*FlowBatchApi* | [**stopAllRows**](docs/FlowBatchApi.md#stopallrows) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/stop-all | Stop All Rows
*FlowBatchApi* | [**stopAllRows_0**](docs/FlowBatchApi.md#stopallrows_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/stop-all | Stop All Rows
*FlowBatchApi* | [**stopRow**](docs/FlowBatchApi.md#stoprow) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id}/stop | Stop Row
*FlowBatchApi* | [**stopRow_0**](docs/FlowBatchApi.md#stoprow_0) | **POST** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id}/stop | Stop Row
*FlowBatchApi* | [**updateBatchRun**](docs/FlowBatchApi.md#updatebatchrun) | **PUT** /v2/flows/{flow_id}/batch/{batch_run_id} | Update Batch Run
*FlowBatchApi* | [**updateBatchRun_0**](docs/FlowBatchApi.md#updatebatchrun_0) | **PUT** /v2/flows/{flow_id}/batch/{batch_run_id} | Update Batch Run
*FlowBatchApi* | [**updateRow**](docs/FlowBatchApi.md#updaterow) | **PUT** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id} | Update Row
*FlowBatchApi* | [**updateRow_0**](docs/FlowBatchApi.md#updaterow_0) | **PUT** /v2/flows/{flow_id}/batch/{batch_run_id}/rows/{row_id} | Update Row
...
*FlowSessionsApi* | [**searchFlowEvent**](docs/FlowSessionsApi.md#searchflowevent) | **POST** /v2/chatbots/sessions/search_event | Search Flow Event
...
*FlowWebhooksApi* | [**executeWebhookTriggerGet**](docs/FlowWebhooksApi.md#executewebhooktriggerget) | **GET** /v2/flows/webhooks/trigger/{webhook_id} | Execute Webhook Trigger Get
*FlowWebhooksApi* | [**executeWebhookTriggerPost**](docs/FlowWebhooksApi.md#executewebhooktriggerpost) | **POST** /v2/flows/webhooks/trigger/{webhook_id} | Execute Webhook Trigger Post
*FlowWebhooksApi* | [**getInstallationMetadata**](docs/FlowWebhooksApi.md#getinstallationmetadata) | **GET** /v2/flows/webhooks/third_party_integrations/installation_metadata | Get Installation Metadata
*FlowsApi* | [**cancelFlowSession**](docs/FlowsApi.md#cancelflowsession) | **POST** /v2/flows/sessions/{session_id}/cancel | Cancel Flow Session
...
*FlowsApi* | [**downloadAttachment**](docs/FlowsApi.md#downloadattachment) | **GET** /v2/flows/sessions/{session_id}/attachments/{file_id} | Download attachment
...
*FlowsApi* | [**getArtefactContent**](docs/FlowsApi.md#getartefactcontent) | **GET** /v2/flows/sessions/{session_id}/artefacts/{artefact_id} | Get artefact content
...
*FlowsApi* | [**resumeHook**](docs/FlowsApi.md#resumehook) | **POST** /v2/flows/sessions/{session_id}/resume-hook | Resume Hook
...
*GitHubApi* | [**getRepos**](docs/GitHubApi.md#getrepos) | **GET** /v2/integrations/github/repos | Get Repos
*GitLabApi* | [**getBranches**](docs/GitLabApi.md#getbranches) | **GET** /v2/integrations/gitlab/branches | Get Branches
*GitLabApi* | [**getProjects**](docs/GitLabApi.md#getprojects) | **GET** /v2/integrations/gitlab/projects | Get Projects
...
*IntegrationsApi* | [**adminUi**](docs/IntegrationsApi.md#adminui) | **POST** /v2/integrations/zendesk_channel/admin_ui | Admin Ui
*IntegrationsApi* | [**channelback**](docs/IntegrationsApi.md#channelback) | **POST** /v2/integrations/zendesk_channel/channelback | Channelback
...
*IntegrationsApi* | [**deleteJiraWebhook**](docs/IntegrationsApi.md#deletejirawebhook) | **DELETE** /v2/integrations/atlassian/jira/webhooks/{webhook_id} | Delete Jira Webhook
*IntegrationsApi* | [**eventsCallback**](docs/IntegrationsApi.md#eventscallback) | **POST** /v2/integrations/zendesk_channel/events | Events Callback
*IntegrationsApi* | [**getActors**](docs/IntegrationsApi.md#getactors) | **GET** /v2/integrations/hubspot/actors/ | Get Actors
*IntegrationsApi* | [**getAirtableBases**](docs/IntegrationsApi.md#getairtablebases) | **GET** /v2/integrations/airtable/ | Get Airtable Bases
*IntegrationsApi* | [**getAirtableTables**](docs/IntegrationsApi.md#getairtabletables) | **GET** /v2/integrations/airtable/bases/{base_id}/tables | Get Airtable Tables
...
*IntegrationsApi* | [**getBranches**](docs/IntegrationsApi.md#getbranches) | **GET** /v2/integrations/gitlab/branches | Get Branches
*IntegrationsApi* | [**getCalendars**](docs/IntegrationsApi.md#getcalendars) | **GET** /v2/integrations/google/calendar | Get Calendars
*IntegrationsApi* | [**getClickupSpaces**](docs/IntegrationsApi.md#getclickupspaces) | **GET** /v2/integrations/clickup/{integration_id}/spaces | Get Clickup Spaces
*IntegrationsApi* | [**getClickupWorkspaces**](docs/IntegrationsApi.md#getclickupworkspaces) | **GET** /v2/integrations/clickup/ | Get Clickup Workspaces
*IntegrationsApi* | [**getConfluencePages**](docs/IntegrationsApi.md#getconfluencepages) | **GET** /v2/integrations/atlassian/confluence/spaces/{space_key}/pages | Get Confluence Pages
*IntegrationsApi* | [**getConfluenceSpaces**](docs/IntegrationsApi.md#getconfluencespaces) | **GET** /v2/integrations/atlassian/confluence/spaces | Get Confluence Spaces
...
*IntegrationsApi* | [**getJiraAssignees**](docs/IntegrationsApi.md#getjiraassignees) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/assignees | Get Jira Assignees
*IntegrationsApi* | [**getJiraIssues**](docs/IntegrationsApi.md#getjiraissues) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/issues | Get Jira Issues
*IntegrationsApi* | [**getJiraProjects**](docs/IntegrationsApi.md#getjiraprojects) | **GET** /v2/integrations/atlassian/jira/projects | Get Jira Projects
*IntegrationsApi* | [**getJiraTransitions**](docs/IntegrationsApi.md#getjiratransitions) | **GET** /v2/integrations/atlassian/jira/issues/{issue_key}/transitions | Get Jira Transitions
*IntegrationsApi* | [**getMembers**](docs/IntegrationsApi.md#getmembers) | **GET** /v2/integrations/wix/members | Get Members
...
*IntegrationsApi* | [**getProjects**](docs/IntegrationsApi.md#getprojects) | **GET** /v2/integrations/gitlab/projects | Get Projects
*IntegrationsApi* | [**getRepos**](docs/IntegrationsApi.md#getrepos) | **GET** /v2/integrations/github/repos | Get Repos
...
*IntegrationsApi* | [**listJiraWebhooks**](docs/IntegrationsApi.md#listjirawebhooks) | **GET** /v2/integrations/atlassian/jira/webhooks | List Jira Webhooks
*IntegrationsApi* | [**listZendeskKbCategories**](docs/IntegrationsApi.md#listzendeskkbcategories) | **GET** /v2/integrations/zendesk/kb/categories | List Zendesk Kb Categories
*IntegrationsApi* | [**listZendeskKbLabels**](docs/IntegrationsApi.md#listzendeskkblabels) | **GET** /v2/integrations/zendesk/kb/labels | List Zendesk Kb Labels
*IntegrationsApi* | [**listZendeskKbSections**](docs/IntegrationsApi.md#listzendeskkbsections) | **GET** /v2/integrations/zendesk/kb/sections | List Zendesk Kb Sections
*IntegrationsApi* | [**manifest**](docs/IntegrationsApi.md#manifest) | **GET** /v2/integrations/zendesk_channel/manifest.json | Manifest
*IntegrationsApi* | [**messagingWebhook**](docs/IntegrationsApi.md#messagingwebhook) | **POST** /v2/integrations/zendesk_channel/messaging_webhook | Messaging Webhook
*IntegrationsApi* | [**messagingWebhookHead**](docs/IntegrationsApi.md#messagingwebhookhead) | **HEAD** /v2/integrations/zendesk_channel/messaging_webhook | Messaging Webhook Head
...
*MemoryApi* | [**getOffloadedContent**](docs/MemoryApi.md#getoffloadedcontent) | **POST** /v2/memory/node/{node_id}/offload/{offload_id} | Get Offloaded Content
...
*MemoryApi* | [**uploadMemoryNodeDocument**](docs/MemoryApi.md#uploadmemorynodedocument) | **POST** /v2/memory/upload/{cat_id} | Upload Memory Node Document
...
*PromptsApi* | [**optimizePrompt**](docs/PromptsApi.md#optimizeprompt) | **POST** /v2/prompts/optimize | Optimize Prompt
...
*SchedulesApi* | [**deleteScheduleUrl**](docs/SchedulesApi.md#deletescheduleurl) | **DELETE** /v2/schedules/{schedule_id}/urls/{domain_id}/{url_id} | Delete Schedule Url
...
*V3Api* | [**checkMigrationReadiness**](docs/V3Api.md#checkmigrationreadiness) | **GET** /v3/flows/{flow_id}/migration-readiness | Check Migration Readiness
*V3Api* | [**createV3FlowAssistantSession**](docs/V3Api.md#createv3flowassistantsession) | **POST** /v3/flow-assistants/create | Create V3 Flow Assistant Session
*V3Api* | [**getAllComponentsV3**](docs/V3Api.md#getallcomponentsv3) | **GET** /v3/flows/components/all | Get All Components V3
*V3Api* | [**getTool**](docs/V3Api.md#gettool) | **GET** /v3/tools/{step_name} | Get Tool
*V3Api* | [**getV3Components**](docs/V3Api.md#getv3components) | **GET** /v3/flows/components/v3 | Get V3 Components
*V3Api* | [**invokeV3FlowAssistantResponse**](docs/V3Api.md#invokev3flowassistantresponse) | **POST** /v3/flow-assistants/{session_id}/invoke | Invoke V3 Flow Assistant Response
*V3Api* | [**listTools**](docs/V3Api.md#listtools) | **GET** /v3/tools | List Tools
*V3Api* | [**migrateFlowToV3**](docs/V3Api.md#migrateflowtov3) | **POST** /v3/flows/{flow_id}/migrate-to-v3 | Migrate Flow To V3
*V3Api* | [**pollV3FlowAssistantResponse**](docs/V3Api.md#pollv3flowassistantresponse) | **POST** /v3/flow-assistants/{session_id}/invocation_response/{from_timestamp} | Poll V3 Flow Assistant Response
*V3Api* | [**validateComponent**](docs/V3Api.md#validatecomponent) | **POST** /v3/flows/components/{component_id}/validate | Validate Component
*V3Api* | [**validateFlow**](docs/V3Api.md#validateflow) | **POST** /v3/flows/validate | Validate Flow
*WebAuthApi* | [**getUser**](docs/WebAuthApi.md#getuser) | **GET** /v2/auth/me | Get User
*WixApi* | [**getMembers**](docs/WixApi.md#getmembers) | **GET** /v2/integrations/wix/members | Get Members
...
*WorkspacesApi* | [**transferWorkspaceOwnership**](docs/WorkspacesApi.md#transferworkspaceownership) | **POST** /v2/workspaces/{workspace_id}/transfer-ownership/{new_owner_user_id} | Transfer Workspace Ownership
*WorkspacesApi* | [**updateWorkspace**](docs/WorkspacesApi.md#updateworkspace) | **PUT** /v2/workspaces/{workspace_id} | Update Workspace
*WorkspacesApi* | [**updateWorkspaceCreditAlertThreshold**](docs/WorkspacesApi.md#updateworkspacecreditalertthreshold) | **PUT** /v2/workspaces/{workspace_id}/credit-alert-threshold | Update Workspace Credit Alert Threshold
*WorkspacesApi* | [**updateWorkspaceCreditLimit**](docs/WorkspacesApi.md#updateworkspacecreditlimit) | **PUT** /v2/workspaces/{workspace_id}/credit-limit | Update Workspace Credit Limit
...
*ZendeskApi* | [**listZendeskKbCategories**](docs/ZendeskApi.md#listzendeskkbcategories) | **GET** /v2/integrations/zendesk/kb/categories | List Zendesk Kb Categories
*ZendeskApi* | [**listZendeskKbLabels**](docs/ZendeskApi.md#listzendeskkblabels) | **GET** /v2/integrations/zendesk/kb/labels | List Zendesk Kb Labels
*ZendeskApi* | [**listZendeskKbSections**](docs/ZendeskApi.md#listzendeskkbsections) | **GET** /v2/integrations/zendesk/kb/sections | List Zendesk Kb Sections
*ZendeskChannelApi* | [**adminUi**](docs/ZendeskChannelApi.md#adminui) | **POST** /v2/integrations/zendesk_channel/admin_ui | Admin Ui
*ZendeskChannelApi* | [**channelback**](docs/ZendeskChannelApi.md#channelback) | **POST** /v2/integrations/zendesk_channel/channelback | Channelback
*ZendeskChannelApi* | [**eventsCallback**](docs/ZendeskChannelApi.md#eventscallback) | **POST** /v2/integrations/zendesk_channel/events | Events Callback
*ZendeskChannelApi* | [**manifest**](docs/ZendeskChannelApi.md#manifest) | **GET** /v2/integrations/zendesk_channel/manifest.json | Manifest
*ZendeskChannelApi* | [**messagingWebhook**](docs/ZendeskChannelApi.md#messagingwebhook) | **POST** /v2/integrations/zendesk_channel/messaging_webhook | Messaging Webhook
*ZendeskChannelApi* | [**messagingWebhookHead**](docs/ZendeskChannelApi.md#messagingwebhookhead) | **HEAD** /v2/integrations/zendesk_channel/messaging_webhook | Messaging Webhook Head


### Documentation For Models

 - [AgentGridBulkInsertResponse](docs/AgentGridBulkInsertResponse.md)
 - [AgentGridCreateRequest](docs/AgentGridCreateRequest.md)
 - [AgentGridFieldRequest](docs/AgentGridFieldRequest.md)
 - [AgentGridFieldResponse](docs/AgentGridFieldResponse.md)
 - [AgentGridFieldType](docs/AgentGridFieldType.md)
 - [AgentGridImportError](docs/AgentGridImportError.md)
 - [AgentGridImportStartResponse](docs/AgentGridImportStartResponse.md)
 - [AgentGridImportStatusResponse](docs/AgentGridImportStatusResponse.md)
 - [AgentGridPreviewResponse](docs/AgentGridPreviewResponse.md)
 - [AgentGridResponse](docs/AgentGridResponse.md)
 - [AgentGridRowInsertRequest](docs/AgentGridRowInsertRequest.md)
 - [AgentGridRowInsertResponse](docs/AgentGridRowInsertResponse.md)
 - [AgentGridRowsBulkInsertRequest](docs/AgentGridRowsBulkInsertRequest.md)
 - [AgentGridSearchRequest](docs/AgentGridSearchRequest.md)
 - [AgentGridSearchResponse](docs/AgentGridSearchResponse.md)
 - [AirtableBaseResponse](docs/AirtableBaseResponse.md)
 - [AirtableBasesResponse](docs/AirtableBasesResponse.md)
 - [AirtableFieldResponse](docs/AirtableFieldResponse.md)
 - [AirtableTableResponse](docs/AirtableTableResponse.md)
 - [AirtableTablesResponse](docs/AirtableTablesResponse.md)
 - [AirtableViewResponse](docs/AirtableViewResponse.md)
 ...
 - [BrandingUpdateRequest](docs/BrandingUpdateRequest.md)
 ...
 - [ClickUpSpaceResponse](docs/ClickUpSpaceResponse.md)
 - [ClickUpWorkspaceResponse](docs/ClickUpWorkspaceResponse.md)
 - [CommunityImageGenerationsResponse](docs/CommunityImageGenerationsResponse.md)
 - [Completed](docs/Completed.md)
 - [ComponentValidateRequest](docs/ComponentValidateRequest.md)
 - [ComponentValidationError](docs/ComponentValidationError.md)
 - [ComponentValidationResponse](docs/ComponentValidationResponse.md)
 - [ConfluencePageResponse](docs/ConfluencePageResponse.md)
 - [ConfluencePagesResponse](docs/ConfluencePagesResponse.md)
 - [ConfluenceSpaceResponse](docs/ConfluenceSpaceResponse.md)
 - [ConfluenceSpacesResponse](docs/ConfluenceSpacesResponse.md)
 - [CreditBalanceResponse](docs/CreditBalanceResponse.md)
 - [CreditDailyChartDataRow](docs/CreditDailyChartDataRow.md)
 - [CreditDailyChartRequest](docs/CreditDailyChartRequest.md)
 - [CreditDailyChartResponse](docs/CreditDailyChartResponse.md)
 ...
 - [FlowBatchArtefactInfo](docs/FlowBatchArtefactInfo.md)
 - [FlowBatchColumnDefinition](docs/FlowBatchColumnDefinition.md)
 - [FlowBatchFilteredExecuteRequest](docs/FlowBatchFilteredExecuteRequest.md)
 - [FlowBatchRowCreateRequest](docs/FlowBatchRowCreateRequest.md)
 - [FlowBatchRowResponse](docs/FlowBatchRowResponse.md)
 - [FlowBatchRowStatus](docs/FlowBatchRowStatus.md)
 - [FlowBatchRowUpdateRequest](docs/FlowBatchRowUpdateRequest.md)
 - [FlowBatchRowsBulkCreateRequest](docs/FlowBatchRowsBulkCreateRequest.md)
 - [FlowBatchRunCreateRequest](docs/FlowBatchRunCreateRequest.md)
 - [FlowBatchRunDetailResponse](docs/FlowBatchRunDetailResponse.md)
 - [FlowBatchRunResponse](docs/FlowBatchRunResponse.md)
 - [FlowBatchRunStatus](docs/FlowBatchRunStatus.md)
 - [FlowBatchRunUpdateRequest](docs/FlowBatchRunUpdateRequest.md)
 ...
 - [FlowEngineVersion](docs/FlowEngineVersion.md)
 - [FlowEventActionType](docs/FlowEventActionType.md)
 - [FlowEventsSearchRequest](docs/FlowEventsSearchRequest.md)
 - [FlowEventsSearchResponse](docs/FlowEventsSearchResponse.md)
 ...
 - [FlowNodeData](docs/FlowNodeData.md)
 - [FlowResponse](docs/FlowResponse.md)
 - [FlowSearchRequest](docs/FlowSearchRequest.md)
 - [FlowSessionAgentCotMetadata](docs/FlowSessionAgentCotMetadata.md)
 - [FlowSessionArtefactContentResponse](docs/FlowSessionArtefactContentResponse.md)
 - [FlowSessionArtefactInfo](docs/FlowSessionArtefactInfo.md)
 - [FlowSessionArtefactsMetadata](docs/FlowSessionArtefactsMetadata.md)
 - [FlowSessionAttachmentMetadata](docs/FlowSessionAttachmentMetadata.md)
 ...
 - [FlowSessionHookWaitingMetadata](docs/FlowSessionHookWaitingMetadata.md)
 ...
 - [FlowSessionResumeHookRequest](docs/FlowSessionResumeHookRequest.md)
 - [FlowSessionTaskResponseMetadata](docs/FlowSessionTaskResponseMetadata.md)
 - [FlowSessionTodoListMetadata](docs/FlowSessionTodoListMetadata.md)
 - [FlowSessionToolCallMetadata](docs/FlowSessionToolCallMetadata.md)
 - [FlowSessionV3FlowAssistantInitMetadata](docs/FlowSessionV3FlowAssistantInitMetadata.md)
 - [FlowSessionV3ToolCallEndMetadata](docs/FlowSessionV3ToolCallEndMetadata.md)
 - [FlowSessionV3ToolCallStartMetadata](docs/FlowSessionV3ToolCallStartMetadata.md)
 ...
 - [FlowValidateRequest](docs/FlowValidateRequest.md)
 - [FlowValidationError](docs/FlowValidationError.md)
 - [FlowValidationResponse](docs/FlowValidationResponse.md)
 ...
 - [GitHubRepoResponse](docs/GitHubRepoResponse.md)
 - [GitHubReposResponse](docs/GitHubReposResponse.md)
 - [GitLabBranchResponse](docs/GitLabBranchResponse.md)
 - [GitLabBranchesResponse](docs/GitLabBranchesResponse.md)
 - [GitLabProjectResponse](docs/GitLabProjectResponse.md)
 - [GitLabProjectsResponse](docs/GitLabProjectsResponse.md)
 ...
 - [GroupingPeriod](docs/GroupingPeriod.md)
 ...
 - [JiraAssigneeResponse](docs/JiraAssigneeResponse.md)
 - [JiraAssigneesResponse](docs/JiraAssigneesResponse.md)
 - [JiraIssueResponse](docs/JiraIssueResponse.md)
 - [JiraIssuesResponse](docs/JiraIssuesResponse.md)
 - [JiraProjectResponse](docs/JiraProjectResponse.md)
 - [JiraProjectsResponse](docs/JiraProjectsResponse.md)
 - [JiraTransitionResponse](docs/JiraTransitionResponse.md)
 - [JiraTransitionsResponse](docs/JiraTransitionsResponse.md)
 - [JiraWebhookResponse](docs/JiraWebhookResponse.md)
 - [JiraWebhooksResponse](docs/JiraWebhooksResponse.md)
 ...
 - [MerchantMetadata](docs/MerchantMetadata.md)
 ...
 - [OptimizedPromptResponse](docs/OptimizedPromptResponse.md)
 ...
 - [PromptOptimizerRequest](docs/PromptOptimizerRequest.md)
 ...
 - [ScheduleUrlDeleteRequest](docs/ScheduleUrlDeleteRequest.md)
 ...
 - [V3ExclusiveGroupResponse](docs/V3ExclusiveGroupResponse.md)
 - [V3ToolListResponse](docs/V3ToolListResponse.md)
 - [V3ToolParameterResponse](docs/V3ToolParameterResponse.md)
 - [V3ToolResponse](docs/V3ToolResponse.md)
 ...
 - [WixMemberResponse](docs/WixMemberResponse.md)
 - [WixMembersResponse](docs/WixMembersResponse.md)
 ...
 - [WorkspaceCreditAlertThresholdRequest](docs/WorkspaceCreditAlertThresholdRequest.md)
 - [WorkspaceCreditLimitRequest](docs/WorkspaceCreditLimitRequest.md)
 ...
 - [ZendeskKBCategoryResponse](docs/ZendeskKBCategoryResponse.md)
 - [ZendeskKBLabelResponse](docs/ZendeskKBLabelResponse.md)
 - [ZendeskKBSectionResponse](docs/ZendeskKBSectionResponse.md)
