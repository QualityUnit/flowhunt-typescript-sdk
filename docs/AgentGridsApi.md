...
|[**deleteAgentGridRow**](#deleteagentgridrow) | **DELETE** /v2/agent_grids/{agent_grid_id}/rows/{row_id} | Delete a row|
...
|[**importAgentGridCsv**](#importagentgridcsv) | **POST** /v2/agent_grids/{agent_grid_id}/import-csv | Import CSV|
...
const { status, data } = await apiInstance.deleteAgentGridRow(
    agentGridId,
    rowId,
    workspaceId
);
...
# **importAgentGridCsv**
> AgentGridImportStartResponse importAgentGridCsv()
...
let agentGridId: string; // (default to undefined)
let workspaceId: string; // (default to undefined)
let file: string; //CSV file to import (default to undefined)

const { status, data } = await apiInstance.importAgentGridCsv(
    agentGridId,
    workspaceId,
    file
);
...
| **agentGridId** | [**string**] |  | defaults to undefined|
| **workspaceId** | [**string**] |  | defaults to undefined|
| **file** | [**string**] | CSV file to import | defaults to undefined|
