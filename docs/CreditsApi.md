...
|[**getDailyChartData**](#getdailychartdata) | **POST** /v2/credits/daily/chart | Get Daily Chart Data|
...
# **getDailyChartData**
> CreditDailyChartResponse getDailyChartData(creditDailyChartRequest)
...
let creditDailyChartRequest: CreditDailyChartRequest; //

const { status, data } = await apiInstance.getDailyChartData(
    workspaceId,
    creditDailyChartRequest
);
```
...
|------------- | ------------- | ------------- | -------------|
| **creditDailyChartRequest** | **CreditDailyChartRequest**|  | |
