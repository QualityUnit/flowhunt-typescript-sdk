...
**rows** | [**Array&lt;FlowBatchRowResponse&gt;**](FlowBatchRowResponse.md) |  | [optional] [default to undefined]
**next_cursor** | **number** |  | [optional] [default to undefined]

## Example

```typescript
import { FlowBatchRunDetailResponse } from 'flowhunt';

const instance: FlowBatchRunDetailResponse = {
    batch_run_id,
    flow_id,
    workspace_id,
    user_id,
