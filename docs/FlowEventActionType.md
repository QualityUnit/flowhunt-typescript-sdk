...
* `AgentCot` (value: `'agent_cot'`)

* `TodoList` (value: `'todo_list'`)

* `Attachment` (value: `'attachment'`)

* `V3ToolCallStart` (value: `'v3_tool_call_start'`)

* `V3ToolCallEnd` (value: `'v3_tool_call_end'`)

* `V3FlowAssistantInit` (value: `'v3_flow_assistant_init'`)

* `HookWaitingForInput` (value: `'hook_waiting_for_input'`)
