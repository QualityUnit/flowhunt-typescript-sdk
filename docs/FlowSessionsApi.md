...
|[**searchFlowEvent**](#searchflowevent) | **POST** /v2/chatbots/sessions/search_event | Search Flow Event|
...
# **searchFlowEvent**
> Array<FlowEventsSearchResponse> searchFlowEvent(flowEventsSearchRequest)
...
let workspaceId: string; // (default to undefined)
let flowEventsSearchRequest: FlowEventsSearchRequest; //

const { status, data } = await apiInstance.searchFlowEvent(
    workspaceId,
    flowEventsSearchRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **flowEventsSearchRequest** | **FlowEventsSearchRequest**|  | |
| **workspaceId** | [**string**] |  | defaults to undefined|


### Return type

**Array<FlowEventsSearchResponse>**
