...
|[**executeWebhookTriggerGet**](#executewebhooktriggerget) | **GET** /v2/flows/webhooks/trigger/{webhook_id} | Execute Webhook Trigger Get|
|[**executeWebhookTriggerPost**](#executewebhooktriggerpost) | **POST** /v2/flows/webhooks/trigger/{webhook_id} | Execute Webhook Trigger Post|
...
# **executeWebhookTriggerGet**
> any executeWebhookTriggerGet()
...
const { status, data } = await apiInstance.executeWebhookTriggerGet(
    webhookId,
    workspaceId
);
```
...
# **executeWebhookTriggerPost**
> any executeWebhookTriggerPost()
...
const { status, data } = await apiInstance.executeWebhookTriggerPost(
    webhookId,
    workspaceId
);
```
