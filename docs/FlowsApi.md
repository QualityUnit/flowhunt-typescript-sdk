...
|------------- | ------------- | -------------|
|[**cancelFlowSession**](#cancelflowsession) | **POST** /v2/flows/sessions/{session_id}/cancel | Cancel Flow Session|
...
|[**downloadAttachment**](#downloadattachment) | **GET** /v2/flows/sessions/{session_id}/attachments/{file_id} | Download attachment|
...
|[**getArtefactContent**](#getartefactcontent) | **GET** /v2/flows/sessions/{session_id}/artefacts/{artefact_id} | Get artefact content|
...
|[**resumeHook**](#resumehook) | **POST** /v2/flows/sessions/{session_id}/resume-hook | Resume Hook|
...
const { status, data } = await apiInstance.cancelFlowSession(
    sessionId
);
```
...
# **getArtefactContent**
> FlowSessionArtefactContentResponse getArtefactContent()
...
let sessionId: string; // (default to undefined)
let artefactId: string; // (default to undefined)

const { status, data } = await apiInstance.getArtefactContent(
    sessionId,
    artefactId
);
```
...
|------------- | ------------- | ------------- | -------------|
| **sessionId** | [**string**] |  | defaults to undefined|
| **artefactId** | [**string**] |  | defaults to undefined|
...
# **resumeHook**
> Completed resumeHook(flowSessionResumeHookRequest)
...
let sessionId: string; // (default to undefined)
let flowSessionResumeHookRequest: FlowSessionResumeHookRequest; //

const { status, data } = await apiInstance.resumeHook(
    sessionId,
    flowSessionResumeHookRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **flowSessionResumeHookRequest** | **FlowSessionResumeHookRequest**|  | |
| **sessionId** | [**string**] |  | defaults to undefined|
