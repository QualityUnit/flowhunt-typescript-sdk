...
* `TiktokIntegration` (value: `'tiktok_integration'`)
...
* `AtlassianOauthIntegration` (value: `'atlassian_oauth_integration'`)
...
* `ZohoIntegration` (value: `'zoho_integration'`)

* `TelegramIntegration` (value: `'telegram_integration'`)

* `AirtableIntegration` (value: `'airtable_integration'`)

* `WixIntegration` (value: `'wix_integration'`)

* `ChameleoonIntegration` (value: `'chameleoon_integration'`)

* `NotionIntegration` (value: `'notion_integration'`)

* `AbraIntegration` (value: `'abra_integration'`)

* `ZendeskIntegration` (value: `'zendesk_integration'`)

* `GitlabIntegration` (value: `'gitlab_integration'`)

* `ClickupIntegration` (value: `'clickup_integration'`)
...
* `GoogleBigqueryIntegration` (value: `'google_bigquery_integration'`)

* `GoogleAnalyticsIntegration` (value: `'google_analytics_integration'`)
