...
|[**transferWorkspaceOwnership**](#transferworkspaceownership) | **POST** /v2/workspaces/{workspace_id}/transfer-ownership/{new_owner_user_id} | Transfer Workspace Ownership|
|[**updateWorkspace**](#updateworkspace) | **PUT** /v2/workspaces/{workspace_id} | Update Workspace|
|[**updateWorkspaceCreditAlertThreshold**](#updateworkspacecreditalertthreshold) | **PUT** /v2/workspaces/{workspace_id}/credit-alert-threshold | Update Workspace Credit Alert Threshold|
|[**updateWorkspaceCreditLimit**](#updateworkspacecreditlimit) | **PUT** /v2/workspaces/{workspace_id}/credit-limit | Update Workspace Credit Limit|
...
> Completed transferWorkspaceOwnership()
...
let workspaceId: string; // (default to undefined)
let newOwnerUserId: string; // (default to undefined)

const { status, data } = await apiInstance.transferWorkspaceOwnership(
    workspaceId,
    newOwnerUserId
);
```
...
|------------- | ------------- | ------------- | -------------|
| **workspaceId** | [**string**] |  | defaults to undefined|
| **newOwnerUserId** | [**string**] |  | defaults to undefined|
...
# **updateWorkspaceCreditAlertThreshold**
> WorkspaceResponse updateWorkspaceCreditAlertThreshold(workspaceCreditAlertThresholdRequest)

Update the credit alert threshold for a workspace. When the credit balance drops to or below the threshold, email and in-app notifications are sent. Set credit_alert_threshold to null to use the system default (10% of monthly plan value). Available to all plan tiers. Only workspace owners and admins can update this setting.
...
let workspaceId: string; // (default to undefined)
let workspaceCreditAlertThresholdRequest: WorkspaceCreditAlertThresholdRequest; //

const { status, data } = await apiInstance.updateWorkspaceCreditAlertThreshold(
    workspaceId,
    workspaceCreditAlertThresholdRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **workspaceCreditAlertThresholdRequest** | **WorkspaceCreditAlertThresholdRequest**|  | |
| **workspaceId** | [**string**] |  | defaults to undefined|
...
# **updateWorkspaceCreditLimit**
> WorkspaceResponse updateWorkspaceCreditLimit(workspaceCreditLimitRequest)

Update the credit consumption limit for a workspace. Only available for workspace owners with AGENCY or ENTERPRISE subscription plans. Set credit_limit to null to remove the limit.
...
let workspaceId: string; // (default to undefined)
let workspaceCreditLimitRequest: WorkspaceCreditLimitRequest; //

const { status, data } = await apiInstance.updateWorkspaceCreditLimit(
    workspaceId,
    workspaceCreditLimitRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **workspaceCreditLimitRequest** | **WorkspaceCreditLimitRequest**|  | |
| **workspaceId** | [**string**] |  | defaults to undefined|
